...
Figure 2 panels a-d and f-h use the author-derived aggregate carrier. Figure 2e
uses the separate public carrier `data/figure_source/figure-02.csv`, registered
as `figure-02-source-real` and documented in `data/dictionaries/figure_02.md`.
The full registry workflow consumes that carrier and writes both
`figures/figure-02e.png` and `figures/figure-02e.pdf`.
