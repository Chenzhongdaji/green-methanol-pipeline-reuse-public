...
| target | Next conceptual stage label when present. | text or not_applicable for terminal stage | explicit not_applicable allowed for terminal stage | workflow-link transcription | Figure 1 (all) |
